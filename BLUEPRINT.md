...
| `sepadan/hadir` | PWA di akar + backend pemasangan dalam `apps-script/` | HADIR v1.8.0; Semak Kehadiran muka depan; relay induk murid/guru; berkongsi backend KEHADIRAN |
